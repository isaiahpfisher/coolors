...
export default function TextAnimationPlayground() {
  ...
  return (
    <>
      <div className="flex h-screen w-screen items-center justify-center bg-stone-50 p-8 text-center font-sans text-zinc-900 lg:hidden">
        <div className="flex flex-col items-center gap-4">
          <img
            src="/preview.gif"
            alt="Preview"
            className="mb-8 w-full max-w-sm rounded-lg shadow-md"
          />
          <h2 className="text-lg font-semibold tracking-tight text-zinc-800">
            Desktop Only
          </h2>
          <p className="text-sm text-zinc-500">
            This site only supports desktop sizes. Please view on a larger
            screen.
          </p>
        </div>
      </div>
      <div className="hidden h-screen w-screen overflow-hidden bg-stone-50 font-sans text-zinc-900 lg:flex">
        {/* ── Preview canvas ──────────────────────────────────────── */}
